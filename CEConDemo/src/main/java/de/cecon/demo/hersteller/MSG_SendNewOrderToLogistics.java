...
public class MSG_SendNewOrderToLogistics implements JavaDelegate {
    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        delegateExecution.getProcessEngineServices().getRuntimeService().
                startProcessInstanceByMessage("new_order_logistics", delegateExecution.getBusinessKey(), variables);
    }
}
